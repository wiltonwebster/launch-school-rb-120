...
=begin
Even though we have defined ==, >, >=, <, and <=, the sort method requires that
the objects be comparable via the <=> operator, which is a method we have not
defined. By defining it in terms of the > and < methods, we can use sort.
=end