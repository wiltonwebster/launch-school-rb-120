...
=begin
The Mailing module was included in Email Service, but not Postal Service. Thus,
the send method was being invoked from a completely different class/module than
what we intended. By including Mailing in the Communications Provider class, we
can invoke the send method on John's postal service and achieve the desired
result.
=end